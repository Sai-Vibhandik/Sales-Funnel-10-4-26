...
marketResearchSchema.index({ organizationId: 1 });
marketResearchSchema.index({ organizationId: 1, projectId: 1 });
marketResearchSchema.index({ organizationId: 1, createdBy: 1 });
