...
trafficStrategySchema.index({ organizationId: 1 });
trafficStrategySchema.index({ organizationId: 1, projectId: 1 });
trafficStrategySchema.index({ organizationId: 1, createdBy: 1 });
